...
// 1. ISOLATE LOGIC INTO A CHILD COMPONENT
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-2xl w-full">
          ...
          <div className="bg-blue-50 rounded-lg p-4 mb-6">
            <h3 className="font-semibold text-blue-900 mb-2 flex items-center">
              <Package className="w-5 h-5 mr-2" /> What happens next?
            </h3>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link href={`/orders/${order?._id}`} className="flex-1 bg-blue-600 text-white px-6 py-3 rounded-md hover:bg-blue-700 text-center font-semibold">
              View Order Details
            </Link>
            <Link href="/products" className="flex-1 border border-gray-300 px-6 py-3 rounded-md hover:bg-gray-50 text-center font-semibold">
              Continue Shopping
            </Link>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full">
        ...
        <div className="flex flex-col gap-3">
          <Link href="/checkout" className="bg-blue-600 text-white px-6 py-3 rounded-md hover:bg-blue-700 text-center font-semibold">Try Again</Link>
          <Link href="/cart" className="border border-gray-300 px-6 py-3 rounded-md hover:bg-gray-50 text-center">Back to Cart</Link>
          <Link href="/orders" className="text-gray-600 hover:text-gray-900 text-center text-sm">View My Orders</Link>
        </div>
      </div>
    </div>
  );
...
// 2. MAIN PAGE WRAPS CONTENT IN SUSPENSE
export default function VerifyPaymentPage() {
  return (
    // This boundary catches the bailout caused by useSearchParams
    <Suspense fallback={
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50">
